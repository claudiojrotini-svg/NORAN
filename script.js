...
const initCalculator = () => {
    ...
    slider.addEventListener('input', (e) => {
        ...
        // Formata o valor do investimento (Ex: R$ 5.000)
        investVal.innerText = val.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
        
        // Calcula o retorno (Investimento x ROAS)
        const retorno = val * ROAS;
        
        // Formata o resultado
        resultado.innerText = retorno.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
    });
};
